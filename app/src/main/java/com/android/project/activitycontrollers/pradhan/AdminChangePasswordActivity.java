...
public class AdminChangePasswordActivity extends AppCompatActivity {
    ...
    public void changePassword(View view)
    {
        ...
        {
            adminPassword = mypref.getString(Constants.ADMIN_PASSWORD_KEY, "admin");
        }
        ...
        else if (false == adminPassword.equals(oldPassword))
        {
        ...
        else
        {
            ...
            prefsEditr.putString(Constants.ADMIN_PASSWORD_KEY, newPassword);
            prefsEditr.commit();
            finish();
