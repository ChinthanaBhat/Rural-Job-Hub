                ...
                imageRe.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                    ...
                    public void onSuccess(Uri uri) {
                        ...
                        if(labourer.getLabourerID() != null) {
                            Toast.makeText(AddLabourerActivity.this, Constants.LABOURER_ADDED_SUCCESSFULLY, Toast.LENGTH_LONG).show();
                            Intent intent = new Intent(AddLabourerActivity.this, RozgarSewakHomeActivity.class);
                            startActivity(intent);
                        }
                        else {
                            Toast.makeText(AddLabourerActivity.this, "Error occured when adding Labourer", Toast.LENGTH_LONG).show();
                        }
                        sendSms(labourer.getMobile(), "Rozgar Sewak has added you as Labourer using Android App. \nUsername: " + labourer.getUsername() + "\nPassword: " + labourer.getPassword());
