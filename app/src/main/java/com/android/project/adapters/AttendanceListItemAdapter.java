...
public class AttendanceListItemAdapter extends ArrayAdapter<Labourer> {
    private Activity context;
    List<Labourer> labourerList;
    LayoutInflater inflater;

    public AttendanceListItemAdapter(Activity context, int resourceId)
    {
...
//        CheckBox presentCB;
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        if (view == null) {
            ...
            view = inflater.inflate(R.layout.attendancelist_item, null);
